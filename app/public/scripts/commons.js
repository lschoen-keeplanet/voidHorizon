...
===============================================================`;
  ...
  class EmbeddedCollectionDelta extends EmbeddedCollection {
    ...
    /** @override */
    _createOrUpdate(data, options) {
      if ( this.isTombstone(data._id) ) return;
  ...
  class BasePackage extends DataModel {
    ...
    constructor(data, options={}) {
       ...
       * @type {number}
       */
      this.availability = availability ?? this._testAvailability();
    ...
    /**
     * Restrict the availability this package based on the compatible version range it declares as well as the
     * availability of its required dependencies.
     * This method is implemented on the server side to provide authoritative availability data.
     *
     ...
     * @returns {number}                    A value in CONST.PACKAGE_AVAILABILITY_CODES
     * @internal
     */
    _testAvailability(release) {
      return PACKAGE_AVAILABILITY_CODES.UNKNOWN;
    }
